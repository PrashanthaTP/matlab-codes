...
figure(2);
freqz(h);
title({'Hanning HPF';'Magnitude and Phase plots';'Without Inbuilt Function'});

figure(3)
m= fir1(N,2*fc/fsamp,'high',hann(N+1));
freqz(m);
title({'Hanning HPF';'Magnitude and Phase plots';'Inbuilt Function'});
% fvtool(h);
